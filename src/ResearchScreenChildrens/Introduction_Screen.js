      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.headingAndParaStyle}>
          ...
          >
            ...
            <TTS
              text="The brain is an amazing three-pound organ that controls all
        ...
        <View style={styles.headingAndParaStyle}>
          ...
          >
            ...
            <TTS
              text="While people often speak of their “grey matter“, the brain also
        ...
        <View style={styles.headingAndParaStyle}>
          ...
          >
            ...
            <TTS
              text="The neurons in our brains communicate in a variety of ways.
          ...
          <View style={styles.paraStyle}>
            ...
            <YoutubeVideoPlayer
              imgPath={require("../../youtubeThumbnails/IntroductionScreeenThumbnail.png")}
              title="Introduction To Human Brain"
              url="https://www.youtube.com/watch?v=MWVh7_6kTRM&t=1s"
            />
          </View>
        </View>
      </ScrollView>
