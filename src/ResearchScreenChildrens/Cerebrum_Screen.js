      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.headingAndParaStyle}>
          ...
          >
            ...
            <TTS
              text="Cerebrum, the largest and uppermost portion of the brain. The
        ...
        <View style={styles.headingAndParaStyle}>
          ...
          >
            ...
            <TTS
              text="Numerous deep grooves in the cerebral cortex, called cerebral
              fissures, originate in the extensive folding of the brain’s
              surface. The main cerebral fissures are the lateral fissure, or
              fissure of Sylvius, between the frontal and temporal lobes; the
              central fissure, or fissure of Rolando, between the frontal and
              parietal lobes, which separates the chief motor and sensory
              regions of the brain; the calcarine fissure on the occipital lobe,
              which contains the visual cortex; the parieto-occipital fissure,
              which separates the parietal and occipital lobes; the transverse
              fissure, which divides the cerebrum from the cerebellum; and the
        ...
        <View style={{ marginRight: 5 }}>
          <YoutubeVideoPlayer
            imgPath={require("../../youtubeThumbnails/CerebrumScreenThumbnail.png")}
